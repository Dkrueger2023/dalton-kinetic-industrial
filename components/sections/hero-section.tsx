...
export function HeroSection() {
  return (
    <section className="relative min-h-screen flex flex-col overflow-hidden">
      ...
      <div className="hidden md:block absolute inset-0 bg-gradient-to-b from-black/80 via-black/50 to-black/30" />

      <div className="md:hidden absolute inset-0 bg-gradient-to-t from-black via-black/70 to-transparent" />
      ...
      <div className="relative z-10 w-full max-w-7xl mx-auto px-6 lg:px-8 flex-1 flex items-center">
        <div className="flex flex-col lg:flex-row w-full h-auto">
          {/* LEFT ELEMENT */}
          <div className="w-full lg:w-[60%] flex items-center bg-transparent md:bg-black/40 p-8 md:p-12 lg:border-l-8 border-[#d81e1f]">
            <h1
          ...
          {/* RIGHT ELEMENT */}
          <div className="w-full lg:w-[40%] bg-transparent md:bg-black/40 p-8 md:p-12 lg:border-l-2 border-[#d81e1f] text-white">
