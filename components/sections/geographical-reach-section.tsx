        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="order-2 lg:order-1 text-center lg:text-left">
            ...
            <p className="text-lg text-white/90 mb-8 text-pretty font-[var(--font-sans)]">
              Our operations span four locations across the midwest and north: our HQ in Norman, OK, our Oklahoma yards in Woodward and Amber. This positioning allows us to effectively serve the entire region, including:
            </p>
          ...
          <div className="order-1 lg:order-2">
            <img
              src="https://hebbkx1anhila5yf.public.blob.vercel-storage.com/Kinetic-Reach-Website-TjFfsDYqapilmDPWUkvW3LIWd6P55h.webp"
